...
mostrar_menu(){ 
	...
	echo "4) Mostrar el uso basico del comando awk"
	echo "5) Mostrar el uso basico del comando grep"
	echo "6) Rick"
	echo "7) Salir"
...
#--------------------------------------------------------------------------------------------------
#Esta funcion sirve para mostrar awk
uso_awk(){
...
#---------------------------------------------------------------------------------------------------
#Esta funcion sirve para mostrar grep
uso_grep(){
